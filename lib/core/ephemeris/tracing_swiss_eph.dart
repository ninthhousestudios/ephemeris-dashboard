...
class TracingSwissEph implements SwissEph {
  ...
  JulianDayPair utcToJd(
    ...
    bool gregorian = true,
      ...
      _delegate.utcToJd(year, month, day, hour, min, sec, gregorian: gregorian);
  ...
  @override
  SolarEclipseLocalResult lunOccultWhenLoc(
    double jdStart,
    int body,
    int flags, {
    String? starname,
